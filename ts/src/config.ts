...
export const WHITELISTED_TOKENS: string[] | '*' = _.isEmpty(process.env.WHITELIST_ALL_TOKENS)
    ? [
          ...
          '0x0a5b9a7fc0474390101c075ad158c71779cb400f', // TMK on Kovan
          '0x2d756d19eb0a79b1c98e0fc433425095584878b2', // PPK on Kovan
          '0x4fda2207fab83964bde2a9b75e24cc83af4c21c7' // TMKV2 on Kovan
      ]
